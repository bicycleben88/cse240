/* Basic Description: identify and fix errors 
...
int main(){
   ...
   printf("y is %d\n",y); 
	...
	printf("Error Type: Contextual \n\n");
     ...
     printf("The character %%c denotes a char, whereas y is an int. %%d denotes an int. Because this error was caused by an incorrect data type, it's contextual \n\n");
